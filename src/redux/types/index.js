...
export const LOGIN_FIREBASE_API_HIT_SUCCESS = 'LOGIN_FIREBASE_API_HIT_SUCCESS';
...
export const CHANGE_PLAN_REJECTED = 'CHANGE_PLAN_REJECTED';

export const GET_SUBSCRIPTION = 'GET_SUBSCRIPTION';
export const GET_SUBSCRIPTION_FULFILLED = 'GET_SUBSCRIPTION_FULFILLED';
export const GET_SUBSCRIPTION_PENDING = 'GET_SUBSCRIPTION_PENDING';
export const GET_SUBSCRIPTION_REJECTED = 'GET_SUBSCRIPTION_REJECTED';
...
export const GET_TERMS_AND_CONDITIONS_PENDING =
  'GET_TERMS_AND_CONDITIONS_PENDING';
export const GET_TERMS_AND_CONDITIONS_FULFILLED =
  'GET_TERMS_AND_CONDITIONS_FULFILLED';
export const GET_TERMS_AND_CONDITIONS_REJECTED =
  'GET_TERMS_AND_CONDITIONS_REJECTED';

export const GET_PRIVACY_POLICY = 'GET_PRIVACY_POLICY';
export const GET_PRIVACY_POLICY_PENDING = 'GET_PRIVACY_POLICY_PENDING';
export const GET_PRIVACY_POLICY_FULFILLED = 'GET_PRIVACY_POLICY_FULFILLED';
export const GET_PRIVACY_POLICY_REJECTED = 'GET_PRIVACY_POLICY_REJECTED';

export const GET_LICENSES = 'GET_LICENSES';
export const GET_LICENSES_PENDING = 'GET_LICENSES_PENDING';
export const GET_LICENSES_FULFILLED = 'GET_LICENSES_FULFILLED';
export const GET_LICENSES_REJECTED = 'GET_LICENSES_REJECTED';

export const SET_LICENSES = 'SET_LICENSES';
export const SET_LICENSES_PENDING = 'SET_LICENSES_PENDING';
export const SET_LICENSES_FULFILLED = 'SET_LICENSES_FULFILLED';
export const SET_LICENSES_REJECTED = 'SET_LICENSES_REJECTED';

export const GET_HEALTH_HISTORY = 'GET_HEALTH_HISTORY';
export const GET_HEALTH_HISTORY_PENDING = 'GET_HEALTH_HISTORY_PENDING';
export const GET_HEALTH_HISTORY_FULFILLED = 'GET_HEALTH_HISTORY_FULFILLED';
export const GET_HEALTH_HISTORY_REJECTED = 'GET_HEALTH_HISTORY_REJECTED';

export const UPDATE_HEALTH_HISTORY = 'UPDATE_HEALTH_HISTORY';
export const UPDATE_HEALTH_HISTORY_PENDING = 'UPDATE_HEALTH_HISTORY_PENDING';
export const UPDATE_HEALTH_HISTORY_FULFILLED =
  'UPDATE_HEALTH_HISTORY_FULFILLED';
export const UPDATE_HEALTH_HISTORY_REJECTED = 'UPDATE_HEALTH_HISTORY_REJECTED';
...
export const GET_RESOLVED_QUESTIONS = 'GET_RESOLVED_QUESTIONS';
export const GET_RESOLVED_QUESTIONS_PENDING = 'GET_RESOLVED_QUESTIONS_PENDING';
export const GET_RESOLVED_QUESTIONS_FULFILLED =
  'GET_RESOLVED_QUESTIONS_FULFILLED';
export const GET_RESOLVED_QUESTIONS_REJECTED =
  'GET_RESOLVED_QUESTIONS_REJECTED';

export const GET_UNRESOLVED_QUESTIONS = 'GET_UNRESOLVED_QUESTIONS';
export const GET_UNRESOLVED_QUESTIONS_PENDING =
  'GET_UNRESOLVED_QUESTIONS_PENDING';
export const GET_UNRESOLVED_QUESTIONS_FULFILLED =
  'GET_UNRESOLVED_QUESTIONS_FULFILLED';
export const GET_UNRESOLVED_QUESTIONS_REJECTED =
  'GET_UNRESOLVED_QUESTIONS_REJECTED';

export const GET_FAVORITE_EXPERTS = 'GET_FAVORITE_EXPERTS';
export const GET_FAVORITE_EXPERTS_PENDING = 'GET_FAVORITE_EXPERTS_PENDING';
export const GET_FAVORITE_EXPERTS_FULFILLED = 'GET_FAVORITE_EXPERTS_FULFILLED';
export const GET_FAVORITE_EXPERTS_REJECTED = 'GET_FAVORITE_EXPERTS_REJECTED';

export const UPDATE_FAVORITE_EXPERTS = 'UPDATE_FAVORITE_EXPERTS';
export const UPDATE_FAVORITE_EXPERTS_PENDING =
  'UPDATE_FAVORITE_EXPERTS_PENDING';
export const UPDATE_FAVORITE_EXPERTS_FULFILLED =
  'UPDATE_FAVORITE_EXPERTS_FULFILLED';
export const UPDATE_FAVORITE_EXPERTS_REJECTED =
  'UPDATE_FAVORITE_EXPERTS_REJECTED';

export const SHOW_MESSAGE = 'SHOW_MESSAGE';
export const HIDE_MESSAGE = 'HIDE_MESSAGE';
export const SHOW_MESSAGE_FULFILLED = 'SHOW_MESSAGE_FULFILLED';
export const HIDE_MESSAGE_FULFILLED = 'HIDE_MESSAGE_FULFILLED';

export const SET_LANGUAGE = 'SET_LANGUAGE';
export const SET_CALL_CONFIG = 'SET_CALL_CONFIG';
export const GET_CALL_TOKEN = 'GET_CALL_TOKEN';

export const SET_EXPERT_CALL_CONFIG = 'SET_EXPERT_CALL_CONFIG';
export const GET_EXPERT_CALL_TOKEN = 'GET_EXPERT_CALLTOKEN';
